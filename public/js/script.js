window.addEventListener('DOMContentLoaded', function() {
    ...
    function postData(form) {    
        form.addEventListener('submit', (event) => {
            ...
            fetch('http://localhost:5500', initData)
                .then(response => {
    ...
    function showAppriciateModal(message) {
        const prevModalDialog = document.querySelector('.modal_dialog');

        prevModalDialog.classList.add('hide');
        openModal();

        const appriciateModal = document.createElement('div');
        appriciateModal.classList.add('.modal_dialog');
        appriciateModal.innerHTML = `
